...
NETWORK = {
    'ethereum': {
        ...
        'chain_id': 1,
        'rpc_url': 'https://eth.llamarpc.com',  # Using LlamaRPC as default
...
TRADING_CONFIG = {
    ...
    'min_eth_balance': 0.1,       # Minimum ETH balance to keep
    'min_liquidity': 50000,        # Minimum $50K liquidity
    'min_volume': 10000,           # Minimum $10K 24h volume
    'min_price_change': 2,         # Minimum 2% price change
    'max_liquidity_percent': 1,    # Maximum 1% of pool liquidity
}
...
NETWORK_CONFIG = {
    'default_rpc': NETWORK['ethereum']['rpc_url'],
    'gas_oracle_url': 'https://api.etherscan.io/api',
    'networks': {
        'ethereum': {
            'rpc_url': NETWORK['ethereum']['rpc_url'],
